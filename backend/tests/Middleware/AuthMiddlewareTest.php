...
{
    private AuthServiceInterface $authService; // ← tipo adicionado
    private RequestInterface $request;         // ← tipo adicionado
    private AuthMiddleware $middleware;        // ← tipo adicionado
